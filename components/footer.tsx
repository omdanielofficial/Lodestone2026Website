  ...
  const sections = [
    ...
    },
    {
      ...
      items: [
        ...
        { name: "Affiliate Program", url: "https://billing.lodestone.host/affiliates.php" },
...
<div className="bg-violet-600 px-6 py-2.5">
  <div className="container mx-auto flex max-w-7xl items-center justify-center gap-6">
    <div className="hidden gap-2 md:flex">
      ...
      <p>
        Join our Discord and follow our socials for the latest news and discussions!
      </p>
    </div>
...
<div className="flex items-center gap-3 text-white">
  <Link href="https://youtube.com/@lodestonehost" aria-label="YouTube" target="_blank">
    <FontAwesomeIcon icon={faYoutubeSquare} className="text-2xl hover:text-red-500 transition-colors" />
  </Link>
  <Link href="https://tiktok.com/@lodestonehost" aria-label="TikTok" target="_blank">
    <FontAwesomeIcon icon={faTiktok} className="text-2xl hover:text-gray-300 transition-colors" />
  </Link>
  <Link href="https://bsky.app/profile/lodestone.host" aria-label="Bluesky" target="_blank">
    <FontAwesomeIcon icon={faSquareBluesky} className="text-2xl hover:text-sky-400 transition-colors" />
  </Link>
  <Link href="https://linkedin.com/company/lodestoneuk" aria-label="LinkedIn" target="_blank">
    <FontAwesomeIcon icon={faSquareLinkedin} className="text-2xl hover:text-blue-400 transition-colors" />
  </Link>
</div>
  ...
  >
    Intranex Limited
  </a> T/A Lodestone. All rights reserved. Registered in England & Wales under CRN 16068461.
            </p>
